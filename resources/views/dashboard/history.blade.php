...
@section('content')
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-3">
                                            <div class="d-flex align-items-center">
                                                <div class="avtar bg-light-primary text-primary rounded-circle me-3 shadow-sm d-flex align-items-center justify-content-center flex-shrink-0"
                                        ...
                                        <div class="col-md-2 text-center">
                                            ...
                                            <small class="text-muted text-uppercase fw-bold" style="font-size: 0.65rem;">Total
                                                Points</small>
                                        </div>
    ...
    <style>
        ...
        .bg-success-subtle {
            background-color: rgba(30, 212, 145, 0.1) !important;
        }
        ...
        .border-success-subtle {
            border-color: rgba(30, 212, 145, 0.2) !important;
        }
