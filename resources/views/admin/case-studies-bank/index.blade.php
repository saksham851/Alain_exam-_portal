...
@section('content')
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                        data-bs-target="#addCaseStudyModal">
                        ...
                        <div class="modal-content border-0 shadow-lg">
                            ...
                            <div class="modal-body p-4">
                                ...
                                <div class="row g-3">
                                    <!-- Option 1: Create New -->
                                    <div class="col-md-6">
                                        <a href="{{ route($routePrefix . '.case-studies-bank.create', request()->only(['exam_id', 'section_id'])) }}"
                ...
                <div class="modal fade" id="cloneCaseStudyModal" tabindex="-1" aria-labelledby="cloneCaseStudyModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content border-0 shadow-lg">
                            <div class="modal-header bg-primary text-white border-0">
                            ...
                            <form action="{{ route($routePrefix . '.case-studies-bank.copy') }}" method="POST">
                                @csrf
                                <div class="modal-body p-4">
                                    <p class="text-muted mb-4">Select a source case study to clone into a target section.
                                    </p>

                                    <div class="row g-4">
                                        <!-- Source Configuration -->
                                        <div class="col-md-12">
                                            <h6 class="fw-bold mb-3 text-primary"><i class="ti ti-file-import me-1"></i>
                                                Source Details</h6>

                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label for="clone_source_exam_id" class="form-label fw-bold">Source
                                                        Exam</label>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label for="clone_source_section_id" class="form-label fw-bold">Source
                                                        Section</label>
                                                    <select class="form-select" id="clone_source_section_id" required
                                                        disabled>
                                            ...
                                            <div class="mb-3">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <label class="form-label fw-bold mb-0">Select Case Studies to
                                                        Clone</label>
                                                    <div class="form-check m-0">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="select_all_case_studies">
                                                        <label class="form-check-label fw-bold small text-primary"
                                                            for="select_all_case_studies">Select All</label>
                                                    </div>
                                                </div>

                                                <div id="case_studies_checkbox_list"
                                                    class="row g-2 border rounded p-3 bg-white"
                                        ...
                                        <div class="col-md-12">
                                            <h6 class="fw-bold mb-3 text-success"><i class="ti ti-file-export me-1"></i>
                                                Target Details</h6>

                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label for="clone_target_exam_id" class="form-label fw-bold">Target
                                                        Exam</label>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label for="clone_target_section_id" class="form-label fw-bold">Target
                                                        Section</label>
                                                    <select class="form-select" id="clone_target_section_id"
                                                        name="target_section_id" required disabled>
                                                        <option value="">-- Select Target Exam First --</option>
                                                    </select>
                                                    <small class="text-muted">The case study will be added to this
                                                        section.</small>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="alert alert-info border-0 mb-0 mt-3">
                                        ...
                                        <strong>Note:</strong> Cloning will copy the Case Study logic, Questions, and
                                        Options.
                                    </div>
                                </div>
                        ...
                        <div class="row g-2 align-items-end">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="search" id="searchInput" class="form-control form-control-sm"
                                    placeholder="Search case study title..." value="{{ request('search') }}">
                            </div>
                            ...
                            <!-- Clear Button -->
                            <div class="col-md-1">
                                <a href="{{ route($routePrefix . '.case-studies-bank.index') }}"
                        ...
                        <div class="d-flex align-items-center flex-wrap gap-2">
                            ...
                            @if(request('exam_category'))
                                <span class="badge rounded-pill bg-info">
                                    <i
                                        class="ti ti-category me-1"></i>{{ $examCategories->firstWhere('id', request('exam_category'))->name ?? 'Unknown' }}
                                </span>
                            @endif
                            ...
                            @if(request('exam'))
                                <span class="badge rounded-pill bg-primary">
                                    <i
                                        class="ti ti-file-text me-1"></i>{{ $exams->firstWhere('id', request('exam'))->name ?? 'Unknown' }}
                                </span>
                            @endif
                        </div>
                    </div>
                            ...
                            <tbody>
                                @forelse($caseStudies as $caseStudy)
                                    <tr class="align-middle">
                                        ...
                                        @endphp
                                        <td>
                                            <button class="btn btn-sm btn-icon btn-light-primary rounded-circle shadow-none"
                                                type="button" data-bs-toggle="collapse"
                                                data-bs-target="#collapseCaseStudy{{ $caseStudy->id }}" aria-expanded="false"
                                                aria-controls="collapseCaseStudy{{ $caseStudy->id }}">
                                                <i class="ti ti-chevron-right transition-transform"></i>
                                            </button>
                                        </td>
                                        <td>
                                            <a href="{{ $isActiveExam ? route($routePrefix . '.case-studies-bank.show', $caseStudy->id) : route($routePrefix . '.case-studies-bank.edit', $caseStudy->id) }}"
                                        ...
                                        <td>
                                            @if($caseStudy->cloned_from_id && $caseStudy->clonedFromSection && $caseStudy->clonedFromSection->exam)
                                                <span class="text-muted small">
                                                    Clone from
                                                    <strong>{{ Str::limit($caseStudy->clonedFromSection->exam->name, 20) }}</strong>
                                                </span>
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-light-primary">{{ $caseStudy->section->exam->category->name ?? 'N/A' }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="badge bg-light-info">{{ $caseStudy->section->exam->certification_type ?? 'N/A' }}</span>
                                        </td>
                                        <td class="text-center">
                                            <span class="badge bg-light-success">{{ $caseStudy->questions_count }}
                                                Questions</span>
                                        </td>
                                        <td class="text-end">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item"
                                                            href="{{ route($routePrefix . '.case-studies-bank.show', $caseStudy->id) }}">
                                                    ...
                                                    @if($caseStudy->status == 0)
                                                        <li>
                                                            <form
                                                                action="{{ route($routePrefix . '.case-studies-bank.activate', $caseStudy->id) }}"
                                                                method="POST" class="d-inline-block w-100"
                                                                id="activateCsForm{{ $caseStudy->id }}">
                                                                @csrf
                                                                @method('PATCH')
                                                                <button type="button" class="dropdown-item text-success"
                                                                    onclick="showAlert.confirm('Are you sure you want to restore this case study?', 'Restore Case Study', function() { document.getElementById('activateCsForm{{ $caseStudy->id }}').submit(); })">
                                                    ...
                                                    @else
                                                        <li>
                                                            ...
                                                            @else
                                                                <a class="dropdown-item"
                                                                    href="{{ route($routePrefix . '.case-studies-bank.edit', $caseStudy->id) }}">
                                                                    <i class="ti ti-edit me-2"></i>Edit Case Study
                                                                </a>
                                                            @endif
                                                        </li>
                                                        <li>
                                                            ...
                                                            @else
                                                                <form
                                                                    action="{{ route($routePrefix . '.case-studies-bank.destroy', $caseStudy->id) }}"
                                                                    method="POST" class="d-inline delete-form"
                                                                    id="delete-form-{{ $caseStudy->id }}">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="button" class="dropdown-item text-danger"
                                                                        onclick="showAlert.confirm('Are you sure you want to delete this case study?', 'Delete Case Study', function() { document.getElementById('delete-form-{{ $caseStudy->id }}').submit(); })">
                                                                        <i class="ti ti-trash me-2"></i>Delete Case Study
                                                                    </button>
                                                                </form>
                                                            @endif
                                    ...
                                    <tr class="collapse bg-light-subtle" id="collapseCaseStudy{{ $caseStudy->id }}">
                                        <td colspan="9" class="p-0 border-bottom">
                                            <div class="p-4">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <h6 class="text-uppercase text-muted fw-bold small mb-3">Case Study Flow
                                                            & Structure</h6>
                                                            ...
                                                            <div class="d-flex flex-column gap-3">
                                                                @foreach($caseStudy->visits as $visit)
                                                                    <div class="card border mb-0 shadow-sm">
                                                                        ...
                                                                        <div
                                                                            class="card-header bg-white d-flex align-items-center justify-content-between py-2">
                                                                            ...
                                                                            <div class="d-flex align-items-center gap-2 flex-grow-1">
                                                                                ...
                                                                                <div class="d-flex align-items-center p-1"
                                                                                    ...
                                                                                    <i
                                                                                        class="ti ti-chevron-right transition-transform text-muted"></i>
                                                                                </div>
                                                                                ...
                                                                                <a href="{{ $isActiveExam ? route($routePrefix . '.case-studies-bank.show', $caseStudy->id) : route($routePrefix . '.case-studies-bank.edit', $caseStudy->id) }}#visit-{{ $visit->id }}"
                                                                                    ...
                                                                                    <span
                                                                                        class="badge bg-light-primary text-primary rounded-circle d-flex align-items-center justify-content-center shadow-sm"
                                                                                        style="width: 28px; height: 28px; font-size: 11px;">{{ $loop->iteration }}</span>
                                                                                    <div class="overflow-hidden">
                                                                                        <h6
                                                                                            class="mb-0 fw-bold hover-primary text-truncate">
                                                                                            {{ $visit->title }}</h6>
                                                                                    </div>
                                                                                    <i
                                                                                        class="ti ti-external-link ms-auto text-muted small opacity-50"></i>
                                                                                </a>
                                                                            </div>

                                                                            <!-- Right area (toggles collapse) -->
                                                                            <div class="ms-3 clickable" data-bs-toggle="collapse"
                                                                                data-bs-target="#collapseVisit{{ $visit->id }}"
                                                                                style="cursor: pointer;">
                                                                                <span class="badge bg-light-secondary border text-muted"
                                                                                    style="font-size: 10px;">{{ $visit->questions->count() }}
                                                                                    Questions</span>
                                                                            </div>
                                                                        </div>
                                                                                        ...
                                                                                        @foreach($visit->questions as $question)
                                                                                            <li
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <a href="{{ route($routePrefix . '.questions.edit', $question->id) }}"
                                                                                                        class="text-truncate text-decoration-none text-dark hover-primary"
                                                                                                        title="{{ strip_tags($question->question_text) }}">
                                                                                                        {{ Str::limit(strip_tags($question->question_text), 80) }}
                                                                                                    </a>
                                                                                                </div>
                                                                                                <span
                                                                                                    class="badge bg-light text-dark border">{{ $question->max_question_points ?? 1 }}
                                                                                                    pts</span>
                                                                                            </li>
                                                                                        @endforeach
                                                                                    </ul>
    ...
    @if(session('case_study_created_success'))
        ...
        <div class="modal fade" id="caseStudiesCreatedSuccessModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static"
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content border-0 shadow-lg">
                    ...
                    <div class="modal-body p-4">
                        <p class="text-muted mb-4 text-center">Would you like to add more case studies or proceed to add
                            questions?</p>

                        <div class="row g-3">
                            <!-- Option 1: Create Another Case Study -->
                            <div class="col-md-4">
                                <a href="{{ route('admin.case-studies-bank.create', ['exam_id' => session('selected_exam_id')]) }}"
                                    class="card h-100 border-2 hover-shadow text-decoration-none text-dark"
                                    style="transition: all 0.3s;">
                                    <div class="card-body text-center p-4">
                                        <div class="mb-3">
                            ...
                            <!-- Option 3: Proceed -->
                            <div class="col-md-4">
                                <a href="{{ route('admin.questions.index', ['open_modal' => 'create', 'exam_id' => session('selected_exam_id'), 'section_id' => session('selected_section_id')]) }}"
                                    class="card h-100 border-2 border-primary hover-shadow text-decoration-none text-dark"
                                    style="transition: all 0.3s;">
                                    <div class="card-body text-center p-4">
                                        <div class="mb-3">
                                            <div class="rounded-circle bg-light-primary d-inline-flex align-items-center justify-content-center"
