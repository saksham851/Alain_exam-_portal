...
@section('content')
    ...
    <style>
        ...
        .hover-shadow:hover {
            ...
            box-shadow: 0 10px 20px rgba(0, 10, 20, 0.1) !important;
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    ...
                    <button type="button" class="btn btn-primary d-flex align-items-center gap-2 px-3 fw-bold"
                    ...
                    <form method="GET" action="{{ route($routePrefix . '.questions.index') }}" id="filterForm">
                        <div class="row g-2 align-items-end">
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="exam_category" id="exam_category" class="form-select form-select-sm"
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="question_type" id="question_type" class="form-select form-select-sm"
                                    ...
                                    <option value="single" {{ request('question_type') == 'single' ? 'selected' : '' }}>Single
                                        Choice</option>
                                    <option value="multiple" {{ request('question_type') == 'multiple' ? 'selected' : '' }}>
                            ...
                            <div class="col-md-1">
                                <div class="d-flex gap-1 justify-content-end">
                                    <a href="{{ route($routePrefix . '.questions.index') }}"
                                        class="btn btn-sm btn-light-secondary px-3" title="Clear Filters">
                        ...
                        <div class="d-flex align-items-center flex-wrap gap-2">
                            ...
                            @if(request('case_study'))
                                <span class="badge rounded-pill bg-secondary">
                                    <i
                                        class="ti ti-file-analytics me-1"></i>{{ $caseStudies->firstWhere('id', request('case_study'))->title ?? 'Unknown' }}
                                </span>
                            @endif
                            ...
                            @if(request('question_type'))
                                <span class="badge rounded-pill bg-dark">
                                    <i
                                        class="ti ti-help me-1"></i>{{ request('question_type') == 'single' ? 'Single' : 'Multiple' }}
                                </span>
                            @endif
                        </div>
                    </div>
                        ...
                        <table class="table table-hover table-vcenter mb-0">
                            <thead style="background: #f8fafc;">
                                <tr>
                                    ...
                                    <th class="border-0 text-muted small fw-bold" style="width: 18%;">CATEGORIES & AREAS
                                    </th>
                                    ...
                                    <th class="border-0 text-muted small fw-bold text-center" style="width: 12%;">OPTIONS
                                    </th>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <small class="text-muted d-flex align-items-center flex-wrap">
                                                <span class="me-2"><i class="ti ti-file-text"></i>
                                                    {{ $question->caseStudy->section->title ?? 'N/A' }}</span>
                                                <span
                                                    class="badge bg-light-warning text-warning border border-warning-subtle py-0 px-2"
                                        ...
                                        <td>
                                            <div class="vstack gap-1">
                                                @forelse($question->tags->groupBy('score_category_id') as $catId => $tags)
                                                    ...
                                                    <div class="border rounded p-1 bg-light-subtle shadow-sm"
                                                        style="border-style: dashed !important; min-width: 120px;">
                                                        <small class="fw-bold d-block text-primary mb-1 border-bottom pb-1"
                                                            style="font-size: 8px; letter-spacing: 0.5px; text-transform: uppercase;">
                                                            {{ Str::limit($firstTag->scoreCategory->name, 25) }}
                                                        </small>
                                                        <div class="d-flex flex-wrap gap-1">
                                                            @foreach($tags as $tag)
                                                                <span
                                                                    class="badge bg-white text-dark border border-light-subtle py-1 px-2"
                                        ...
                                        <td>
                                            <div class="small">
                                                ...
                                                <span
                                                    class="text-muted">{{ $question->caseStudy->section->exam->name ?? 'N/A' }}</span>
                                            </div>
                                        </td>
                                        <td>
                                            @if($question->cloned_from_id && $question->clonedFrom && $question->clonedFrom->caseStudy && $question->clonedFrom->caseStudy->section && $question->clonedFrom->caseStudy->section->exam)
                                                <span class="text-muted small">
                                                    Clone from
                                                    <strong>{{ Str::limit($question->clonedFrom->caseStudy->section->exam->name, 20) }}</strong>
                                                </span>
                                        ...
                                        <td class="text-center">
                                            <span class="badge bg-light-info mb-1 d-block">{{ $question->options->count() }}
                                                Options</span>
                                            <span
                                                class="badge bg-light-success d-block">{{ $question->options->where('is_correct', 1)->count() }}
                                                Correct</span>
                                        </td>
                                        <td class="text-end">
                                            @php
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    @if($question->status == 0)
                                                        <li>
                                                            <form
                                                                action="{{ route($routePrefix . '.questions.activate', $question->id) }}"
                                                                method="POST" class="d-inline-block w-100"
                                                                id="activateForm{{ $question->id }}">
                                                                @csrf
                                                                @method('PATCH')
                                                                <button type="button" class="dropdown-item text-success"
                                                                    onclick="showAlert.confirm('Are you sure you want to restore this question?', 'Restore Question', function() { document.getElementById('activateForm{{ $question->id }}').submit(); })">
                                                    ...
                                                    @else
                                                        ...
                                                        <li>
                                                            ...
                                                            @else
                                                                <form
                                                                    action="{{ route($routePrefix . '.questions.destroy', $question->id) }}"
                                                                    method="POST" class="d-inline-block w-100"
                                                                    id="deleteForm{{ $question->id }}">
                                                                    @csrf @method('DELETE')
                                                                    <button type="button" class="dropdown-item text-danger"
                                                                        onclick="showDeleteModal(document.getElementById('deleteForm{{ $question->id }}'), 'Are you sure you want to delete this question?')">
                                                                        <i class="ti ti-trash me-2"></i>Delete Question
                                                                    </button>
                                                                </form>
                                                            @endif
    ...
    <div class="modal fade" id="cloneQuestionModal" tabindex="-1" aria-labelledby="cloneQuestionModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-primary text-white border-0">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4">
                                        <label for="clone_source_section_id" class="form-label fw-bold">Source
                                            Section</label>
                                        <select class="form-select form-select-sm" id="clone_source_section_id" required
                                            disabled>
                                            <option value="">-- Select Source Exam First --</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="clone_source_case_study_id" class="form-label fw-bold">Source Case
                                            Study</label>
                                        <select class="form-select form-select-sm" id="clone_source_case_study_id" required
                                            disabled>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <div class="form-check m-0">
                                            ...
                                            <label class="form-check-label fw-bold small text-primary"
                                                for="select_all_questions">Select All</label>
                                        </div>
                                    </div>

                                    <div id="questions_checkbox_list" class="row g-2 border rounded p-3 bg-white"
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4">
                                        <label for="clone_target_section_id" class="form-label fw-bold">Target
                                            Section</label>
                                        <select class="form-select form-select-sm" id="clone_target_section_id" required
                                            disabled>
                                            <option value="">-- Select Target Exam First --</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        <label for="clone_target_case_study_id" class="form-label fw-bold">Target Case
                                            Study</label>
                                        <select class="form-select form-select-sm" id="clone_target_case_study_id" required
                                            disabled>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select form-select-sm" id="clone_target_visit_id"
                                            name="target_visit_id" required disabled>
                                            <option value="">-- Select Target Case Study First --</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="mt-2 text-center">
                                    <small class="text-muted"><i class="ti ti-info-circle me-1"></i> The selected questions
                                        will be added to this specific visit.</small>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    @if(session('question_created_success'))
        ...
        <div class="modal fade" id="questionCreatedSuccessModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static"
                ...
                <div class="modal-content border-0 shadow-lg">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('admin.questions.create', ['exam_id' => session('selected_exam_id'), 'section_id' => session('selected_section_id'), 'case_study_id' => session('selected_case_study_id')]) }}"
                                    class="card h-100 border-2 hover-shadow text-decoration-none text-dark"
                                    style="transition: all 0.3s;">
                                    <div class="card-body text-center p-4">
                                        <div class="mb-3">
