    ...
    <div class="navbar-wrapper">
        <div class="m-header">
            <a href="/" class="b-brand text-primary">
                ...
                <img src="{{ asset('assets/images/logo-new.png') }}" class="img-fluid logo-lg" alt="logo"
        ...
        <div class="navbar-content">
            <ul class="pc-navbar">
                ...
                @if(auth()->check() && in_array(auth()->user()->role, ['admin', 'superadmin']))
                    ...
                    <li class="pc-item pc-caption">
                        <label class="fw-bold text-uppercase small"
                            style="letter-spacing: 1px; color: #94a3b8;">Administrator</label>
                    ...
                    @if(auth()->check() && in_array(auth()->user()->role, ['admin', 'superadmin']))
                        <li
                            class="pc-item {{ request()->routeIs('admin.admins.*') || request()->routeIs('superadmin.admins.*') ? 'active' : '' }}">
                            <a href="{{ auth()->user()->role === 'admin' ? route('admin.admins.index') : route('superadmin.admins.index') }}"
                                class="pc-link">
                                <span class="pc-micon"><i class="ti ti-users"></i></span>
                    ...
                    <li
                        ...
                        style="display: block;" @endif>
                            ...
                            <li class="pc-item {{ request()->routeIs('manager.case-studies-bank.*') ? 'active' : '' }}">
                                <a href="{{ route('manager.case-studies-bank.index') }}" class="pc-link">Case Studies
                                    Bank</a>
                            </li>
                ...
                @if(auth()->check() && auth()->user()->role === 'student')
                    {{-- STUDENT LINKS --}}
                    <li class="pc-item pc-caption">
                        <label class="fw-bold text-uppercase small" style="letter-spacing: 1px; color: #94a3b8;">Student
                            Center</label>
